...
Map<String, Object> doc = pw.documents().createAndWait(Map.of(
    "templateId", "tmpl_invoice",
    "payload", Map.of("number", "INV-001"),
    "output", Map.of("pdfUa", "1")   // "1" | "none"
), new WaitOptions());
System.out.println(doc.get("accessibility"));  // {standard=PDF/UA-1, conformant=true, ...}

Map<String, Object> report = pw.documents().accessibility((String) doc.get("id"));
```
